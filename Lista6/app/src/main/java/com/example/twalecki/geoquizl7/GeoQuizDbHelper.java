...
public class GeoQuizDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + QuestionContract.QuestionEntry.TABLE_NAME + " (" +
                    ...
                    QuestionContract.QuestionEntry.COLUMN_NAME_QUESTION + " TEXT," +
                    QuestionContract.QuestionEntry.COLUMN_NAME_ANSWER + " INTEGER)";

    private static final String SQL_DELETE_ENTRIES =
            "DROP TABLE IF EXISTS " + QuestionContract.QuestionEntry.TABLE_NAME;
}